...
/// Parse authorization check failures from the policy/facts
pub fn parse_authorization_failure(
    subject: Option<&str>,
    resource: Option<&str>,
    ...
    let subject = subject.or(parsed_subject.as_deref()).unwrap_or("<unknown>");
